...
namespace Mototaxi.Road
{
    ...
    public class GeoJsonToGizmosSc : MonoBehaviour
    {
        ...
        [SerializedDictionary("Street Name", "Nodes")]
        public SerializedDictionary<string, List<Vector3>> unityFeatureNodes = new();
        ...
        private void ParseGeoJson()
        {
            ...
            GEOJson.GeoJsonData data = JsonConvert.DeserializeObject<GEOJson.GeoJsonData>(geoJsonFile.text);
